...
This will be crucially important when we get to the second derivative
test: it will turn out that the second derivative is a symmetric
bilinear form, and the definiteness of this bilinear form is analogous
to the concavity of a function of one variable.  Identifying local
maxima and minima with the ``second derivative test'' will require
analysis of the eigenvalues of the associated linear map.
