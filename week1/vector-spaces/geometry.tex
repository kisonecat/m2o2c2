...
\begin{question}
  ...
  \begin{solution}
    ...
    \begin{multiple-choice}
      \choice[correct]{$\verticalvector{-4\\2}$}
      \choice{$\verticalvector{3\\-3}$}
      \choice{$\verticalvector{-4\\-2}$}
      \choice{$\verticalvector{4\\2}$}
    \end{multiple-choice}
  \end{solution}
\end{question}
...
\begin{question}
  ...
  \begin{tikzpicture}
    ...
    \draw[->] (0,0) -- (2,3);
    \node[anchor=south east] () at (2,3) {$\vec{v}_1$};

    \draw[->] (0,0) -- (4,1);
    \node[anchor=north west] () at (4,1) {$\vec{v}_2$};
    ...
    \draw[->] (0,0) -- (6,4);
    \node[anchor=south west] () at (6,4) {$\vec{v}_1 + \vec{v}_2$};
  \end{tikzpicture}
  \end{hint}
