...
\begin{definition}
  ...
  Symbolically, for a map to be linear, we must have that $L(\vec{v}+\vec{w}) =
  L(\vec{v})+L(\vec{w})$ for all $\vec{v},\vec{w} \in \R^n$ and also $L(a\vec{v}) = a L(\vec{v})$ for all
  $a \in \R$ and $\vec{v}\in \R^n$.
\end{definition}
