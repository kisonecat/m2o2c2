...
\begin{document}
	...
	\begin{question}
		...
		\begin{solution}
			\begin{hint}
				By using a computer algebra system, we see that the eigenvalues of the Hessian are $3$ and $9$.  
			\end{hint}
			\begin{hint}
	...
	\begin{question}
		...
		\begin{solution}
			...
			\end{hint}
			\begin{hint}
				According to computer algebra software, the eigenvalues of this matrix are  approximately $9.31662$, $-1$ and $2.68338$, so the second derivative
				is indefinite
			\end{hint}
			\begin{hint}
