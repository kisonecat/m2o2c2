...
PAGE_CODE=$(curl -L -e https://class.coursera.org/$COURSERA_COURSE/wiki/all --cookie "$COOKIES $MORE_COOKIES" https://class.coursera.org/m2o2c2-001/wiki/$PAGE | grep /admin/coursepages/ | sed 's/.*\/admin\/coursepages\///;s/".*//')
