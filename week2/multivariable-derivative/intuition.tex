...
\begin{solution}
	...
	\begin{hint}
		\begin{align*}
		3.04 &\approx 3+ D(f)\big|_{(1,2)}\left( \begin{bmatrix}0.01\\0\end{bmatrix} \right)\\
		0.04 &\approx 0.01D(f)\big|_{(1,2)}\left( \begin{bmatrix}1\\0 \right) \text{ by the linearity of the derivative}\\
		D(f)\big|_{(1,2)}\left( \begin{bmatrix}1\\0 \right) &\approx 4
		\end{align*}
	\end{hint}
	\begin{hint}
		\begin{align*}
		f(1,2.002) &\approx f(1,2) + D(f)\big|_{(1,2)}\left( \begin{bmatrix}0\\0.002\end{bmatrix} \right)
		3.002 &\approx 3+ D(f)\big|_{(1,2)}\left( \begin{bmatrix}0\\0.002\end{bmatrix} \right)\\
		0.002 &\approx 0.002D(f)\big|_{(1,2)}\left( \begin{bmatrix}1\\0\end{bmatrix} \right) \text{by the linearity of the derivative}\\
		D(f)\big|_{(1,2)}\left( \begin{bmatrix}1\\0\end{bmatrix} \right) &\approx 1
		\end{align*}
	\end{hint}
	\begin{hint}
...
this function had a derivative, we could obtain the approximate value of the function at \textbf{any} near by point by exploiting linearity.  \textit{That is powerful.}
\end{question}
