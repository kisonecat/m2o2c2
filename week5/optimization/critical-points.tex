...
\begin{document}
	...
	\begin{definition}
		A function $f:\R^n \to \R$ has a \textbf{local maximum} at the point $\mathbf{p} \in \R^n$ if there is an $\epsilon \ge 0$ so that for all $\mathbf{x} \in \R^n$
	...
	\begin{free-response}
		A function $f:\R^n \to \R$ has a \textbf{local minimum} at the point $\mathbf{p} \in \R^n$ if there is an $\epsilon \ge 0$ so that for all $\mathbf{x} \in \R^n$
