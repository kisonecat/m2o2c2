...
We have not made precise what we mean by the approximate sign.  After all, if $\Delta x$ is small enough and $f$ is continuous, 
...
\begin{definition}
  ...
  \[ \displaystyle\lim_{\Delta x \to 0} \frac{\left|\text{Error}_a(\Delta x)\right|}{\left|\Delta x\right|} = 0 \].
...
\begin{free-response}
  ...
  \[m = \displaystyle\lim_{\Delta x \to 0}\frac{f(a+\Delta x)-f(a)}{\Delta x}\]
